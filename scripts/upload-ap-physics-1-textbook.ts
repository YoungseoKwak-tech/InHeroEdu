/**
 * scripts/upload-ap-physics-1-textbook.ts
 *
 * One-shot migration: take the 56 chapter PDFs in
 * /AP_Physics_1_PDFs_56 and stand up the AP Physics 1 textbook the
 * same way ap-bio-ultimate and ap-chem-ultimate were set up.
 *
 *   npx tsx scripts/upload-ap-physics-1-textbook.ts
 *   npx tsx scripts/upload-ap-physics-1-textbook.ts --dry-run
 */
...
const SLUG = "ap-physics-ultimate";
const COURSE_SLUG = "ap-physics-1";
const TITLE = "AP Physics 1";
const SUBTITLE = "The Ultimate Guide";
const AUTHOR = "Youngseo Kwak";
const PDF_DIR = "AP_Physics_1_PDFs_56";
const STORAGE_BUCKET = "textbooks";
const TOTAL_UNITS = 7;
const TOTAL_CHAPTERS = 56;
const DRY_RUN = process.argv.includes("--dry-run");

// AP Physics 1 CED unit titles (College Board, 2024-25 CED — Algebra-
// based, 7-unit structure adopted for the redesigned exam).
