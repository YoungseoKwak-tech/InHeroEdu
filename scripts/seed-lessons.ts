...
import lessonData from "../lib/data/ap-lesson-breakdown.json";

type LessonBreakdown = typeof lessonData;
...
async function seedLessons() {
  ...
  for (const course of (lessonData as LessonBreakdown).courses) {
