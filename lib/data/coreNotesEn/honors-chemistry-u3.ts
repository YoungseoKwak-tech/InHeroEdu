    ...
    sections: [
      {
        ...
        traps: [],
        example: "How many oxygen atoms are in 2 mol of O₂ molecules? 2 mol × (6.022 × 10²³ molecules / 1 mol) = 1.204 × 10²⁴ molecules, and each O₂ has 2 atoms, so 1.204 × 10²⁴ × 2 = 2.409 × 10²⁴ atoms of oxygen.",
      },
      {
    ...
    sections: [
      {
        ...
        traps: [],
        example: "Check that CH₄ + 2O₂ → CO₂ + 2H₂O is balanced: left side has 1 C, 4 H, 4 O; right side has 1 C (in CO₂), 4 H (in 2H₂O), and 4 O (2 in CO₂ + 2 in 2H₂O). Every element's atom count matches, so mass is conserved.",
      },
      {
      ...
      },
      {
        ...
        example: "Balance Al + H₂SO₄ → Al₂(SO₄)₃ + H₂ by treating SO₄ as one unit: put 2 Al, 3 H₂SO₄, and 3 SO₄ on the right, giving 2Al + 3H₂SO₄ → Al₂(SO₄)₃ + 3H₂. Now Al = 2, sulfate units = 3, and H = 6 on both sides.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        traps: [],
        example: "For 2H₂ + O₂ → 2H₂O, how many moles of H₂ react with 5 mol of O₂? Use the mole ratio 2 mol H₂ / 1 mol O₂: 5 mol O₂ × (2 mol H₂ / 1 mol O₂) = 10 mol H₂.",
      },
      {
      ...
      },
      {
        ...
        example: "A reaction has a theoretical yield of 34 g NH₃ but only 27.2 g is collected. Percent yield = (27.2 g / 34 g) × 100% = 80.0%, meaning 20% of the possible product was lost to side reactions or handling.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        traps: [],
        example: "In 2H₂ + O₂ → 2H₂O, mixing 3 mol H₂ with 3 mol O₂: H₂ needs only 1.5 mol O₂ to react fully, so H₂ runs out first and is the limiting reactant. O₂ is in excess, with 3 − 1.5 = 1.5 mol left over.",
      },
      {
      ...
      },
      {
        ...
        example: "N₂ + 3H₂ → 2NH₃ with 1 mol N₂ (limiting) and 5 mol H₂: product = 1 mol N₂ × (2 mol NH₃ / 1 mol N₂) = 2 mol NH₃. H₂ consumed = 1 mol N₂ × (3 mol H₂ / 1 mol N₂) = 3 mol, so H₂ remaining = 5 − 3 = 2 mol.",
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        traps: [],
        example: "A compound is 40.0% C, 6.7% H, 53.3% O by mass. In 100 g: C = 40.0/12.01 = 3.33 mol, H = 6.7/1.01 = 6.63 mol, O = 53.3/16.00 = 3.33 mol. Dividing by the smallest (3.33) gives 1 : 2 : 1, so the empirical formula is CH₂O.",
      },
      {
