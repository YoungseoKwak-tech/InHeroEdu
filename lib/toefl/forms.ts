...
import { TOEFL_FORM_9 } from "./form9";
import { TOEFL_FORM_10 } from "./form10";

/** All available TOEFL practice tests, in display order. */
export const TOEFL_FORMS: ToeflForm[] = [
  TOEFL_FORM_1, TOEFL_FORM_2, TOEFL_FORM_3, TOEFL_FORM_4, TOEFL_FORM_5,
  TOEFL_FORM_6, TOEFL_FORM_7, TOEFL_FORM_8, TOEFL_FORM_9, TOEFL_FORM_10,
];
